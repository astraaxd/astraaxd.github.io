    ...
    const cheat = (async () => {
        ...
        const Cheats = {
            global: [
                {
                    name: "Answer Bot",
                    description: "Answers every question for you. (Now with typing support!)",
                    type: "toggle",
                    enabled: false,
                    data: null,
                    run: function () {
                ...
                },
                {
                    ...
                    description: "Makes every correct answer green, and incorrects red.",
                    type: "toggle",
                    enabled: false,
                    data: null,
                    run: function () {
                ...
                },
                {
                    ...
                    description: "Removes every correct answer's shadow.",
                    type: "toggle",
                    enabled: false,
                    data: null,
                    run: function () {
                ...
                {
                    name: "Percent Answer Bot",
                    description: "Answers questions for you correctly or incorrectly depending on the given goal grade. Disable and re-enable to update goal. (Now with typing support!)",
                    inputs: [
                        {
                            name: "Target Grade",
                            type: "number",
                ...
                {
                    name: "Answer Bot",
                    description: "Answers only the current question for you. (Now with typing support!)",
                    run: function () {
                        const stateNode = getStateNode();
                        const Question = stateNode.state.question || stateNode.props.client.question;
                        if (stateNode.state.question.qType != "typing") {
    ...
    run: function () {
        if (!this.enabled) {
            ...
            royale: [
                {
                    name: "Answer Bot",
                    description: "Answers every question for you.",
                    type: "toggle",
                    enabled: false,
                    data: null,
                    run: function () {
                ...
                {
                    name: "Answer Bot",
                    description: "Answers only the current question for you.",
                    run: function () {
                        let stateNode = getStateNode();
                        stateNode?.onAnswer?.(true, stateNode.props.client.question.correctAnswers[0]);
                    },
            ...
            kingdom: [
                ...
                },
                {
                    ...
                    description: "REAL tax evasion glitch 2025 UNPATCHED",
                    run: function () {
            ...
            flappy: [
                {
                    name: "Noclip",
                    description: "Lets you go through... everything!!!",
                    type: "toggle",
                    enabled: false,
                    run: function () {
                ...
                {
                    name: "Set Score",
                    description: "Sets the current flappy blook score.",
                    inputs: [
                        {
                            name: "Score",
                            type: "number",
